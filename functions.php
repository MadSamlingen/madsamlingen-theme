...
// Madsamlingens funktioner:


// Opskrifter custom post:
function codex_custom_init() {
  $labels = array(
    ...
    'new_item' => 'Ny opskrift',
    'all_items' => 'Alle opskrifter',
    'view_item' => 'Se opskrift',
    'search_items' => 'Søg blandt opskrifter',
    'not_found' =>  'Ingen opskrifter fundet',
    'not_found_in_trash' => 'Ingen opskrifter fundet i papirkurven', 
    'parent_item_colon' => '',
    'menu_name' => 'Opskrifter'
  );
  ...
  register_post_type( 'opskrift', $args );
}
